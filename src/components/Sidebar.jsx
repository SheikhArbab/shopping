        ...
        <div className="h-full pt-10 px-2">
          {
            getProducts.length > 0 ?
              ...
              getProducts.map((product) => (
                ...
                <div key={product.id} className="mt-10 mb-14 flex justify-between w-full h-36 flex-wrap bg-white shadow-md p-3 ">
                  ...
                  <div className="flex items-center justify-between w-full mt-auto">
                    <div className="text-indigo-600 h-fit"> ${Math.round(product.price * product.quantity)}</div>
              ...
              <div className='flex items-center justify-center flex-col h-full w-full pb-10'>

                <div className='h-full w-full flex flex-wrap flex-col items-center justify-center font-semibold  capitalize  text-gray-900 text-sm'>Your cart is currently empty. <button className='w-full bg-gray-900 text-white  rounded-md py-2 mt-2'><Link to={'/'}>Home</Link></button>


                </div>

                <div className='text-xs'>Shipping & taxes calculated at checkout</div>
