...
const Footer = () => {
  return (
   <footer className="font-[sans-serif] bg-[#27282b] py-8 px-16 -mb-10">
  <div className="grid max-md-grid-cols-1 lg:grid-cols-2 gap-20">
    <div>
      <h4 className="text-white font-semibold text-lg">About Us</h4>
      <p className="text-sm mt-4 text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
        mi eu pulvinar cursus, sem elit interdum mauris dipiscing elit. Aenean gravida,
        mi eu pulvinar cursus... <a  className="text-sm font-semibold text-[#007bff]">Read
          more</a></p>
      ...
      <ul className="grid max-sm:grid-cols-1 sm:grid-cols-2 mt-12 gap-2">
        <li className="flex items-center max-sm:mb-8">
          ...
          <a href="" className="text-[#fff] text-sm ml-3">
    ...
    <div>
      ...
      <p className="text-sm mt-4 text-gray-400">Subscribe to our newsletter and stay up to date with the latest news,
      ...
      <div className="bg-[#343538] flex px-2 py-1 rounded-full mt-12">
        ...
        <button type='button'
          className="bg-[#007bff] hover:bg-[#2b5ad0] transition-all text-white font-semibold text-sm rounded-full px-5 py-2 ml-4">Submit</button>
      </div>
  ...
  <div className="lg:flex lg:item-center text-center mt-12">
    <ul className="sm:flex max-lg:justify-center space-x-4">
      ...
      <li>
        <a  className='text-gray-400 hover:text-white text-sm'>Security</a>
      </li>
    </ul>
    <p className='text-sm text-gray-400 lg:ml-auto max-lg:mt-4'>Copyright © 2023<a  className="hover:underline mx-1">ReadymadeUI</a>All Rights Reserved.</p>
  </div>
</footer>
  )
}
