...
return (
    <>
        ...
        <div className='flex py-10  items-center justify-center gap-10 md:justify-between md:px-20 flex-wrap w-full'>
            ...
            <div className='flex items-center justify-center flex-col'>
                ...
                <div className="border product group hover:shadow-md flex duration-300 flex-col hover:shadow-blue-400 hover:translate-y-[-8px] transition-all h-[22rem] rounded-2xl w-60  py-3 px-1 bg-white overflow-hidden">
